...
namespace Photon.NINA.Skyflats.SkyflatsDockables {
    /// <summary>
    ...
    public class SkyflatsDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public SkyflatsDockable(
            ...
            dict.Source = new Uri("Photon.NINA.Skyflats;component/SkyflatsDockables/SkyflatsDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Photon.NINA.Skyflats_AltitudeSVG"];
