...
namespace Photon.NINA.Skyflats {
    ...
    public class SkyflatsTrigger : SequenceTrigger {
        /// <summary>
        ...
        public override bool ShouldTrigger(ISequenceItem previousItem, ISequenceItem nextItem) {
            double minSkyQuality = 18.0;
            double maxSkyQuality = 21.0;
            return weatherDataMediator.GetInfo().SkyQuality >= minSkyQuality && weatherDataMediator.GetInfo().SkyQuality <= maxSkyQuality;
        }
